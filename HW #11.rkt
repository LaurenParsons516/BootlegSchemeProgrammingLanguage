...
(define construct-scope
  (lambda (list-of-2-lists env)
    (if (empty? list-of-2-lists)
        '()
        (cons
         (list (caar list-of-2-lists) (run-parsed-code (cadar list-of-2-lists) env))
         (construct-scope (cdr list-of-2-lists) (cons (list (list (caar list-of-2-lists) (run-parsed-code (cadar list-of-2-lists) env))) env))))))
...
(define sample-no-code '(local-vars ((a 2) (b 5) (c a)) c))
